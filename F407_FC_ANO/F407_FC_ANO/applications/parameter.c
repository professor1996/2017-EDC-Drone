...
// 	sensor_setup.Offset.Gyro_Temperature = 0;
  ...
  /* PID 默认值 */
	pid_setup.groups.ctrl1.pitch.kp = 1.2;
	pid_setup.groups.ctrl1.roll.kp  = 1.2;	
	pid_setup.groups.ctrl1.yaw.kp   = 1.2;	
	
	pid_setup.groups.ctrl1.pitch.ki = 0;  // 0.1
	pid_setup.groups.ctrl1.roll.ki  = 0; // 0.1	
	pid_setup.groups.ctrl1.yaw.ki   = 1.0;	  
	
	
	pid_setup.groups.ctrl1.pitch.kd = 3.0;  // 2.5
	pid_setup.groups.ctrl1.roll.kd  = 2.5;	
  ...
  pid_setup.groups.ctrl2.roll.kp  = 0.5;	
	...
	pid_setup.groups.ctrl2.pitch.ki = 0;   // 0.05  关键
	pid_setup.groups.ctrl2.roll.ki  = 0;// 0.05
